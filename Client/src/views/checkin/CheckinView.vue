...
.checked-in-state { padding: var(--space-6) 0; }
.checked-text {
...
.checked-sub { color: var(--text-secondary); font-size: var(--text-sm); }
...
.legend-dot.unchecked { background: var(--bg-elevated); border: 1px solid var(--border-default); }
</style>
